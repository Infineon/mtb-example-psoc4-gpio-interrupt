...
[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
This example uses the board's default configuration for all the kits listed above, except the CY8CPROTO-040T and CY8CPROTO-040T-MS.

In order to use the User Button in CY8CPROTO-040T or CY8CPROTO-040T-MS, short J6.2 and J6.3 with the jumper shunt on the kit. See the kit guide to ensure that the board is configured correctly.
